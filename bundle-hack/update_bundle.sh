...
# Arch support is statically declared from the known build-platforms set.
export AMD64_BUILT=1
export ARM64_BUILT=1
export PPC64LE_BUILT=1
export S390X_BUILT=1
